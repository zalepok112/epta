...
<p>
<label>Час реєстрації:<br /></label>
<?php print $row['time']?><br /><br />
</p>
<p>
<label>Останній раз був онлайн:<br /></label>
<?php print $row['time2']?><br /><br />
</p>
<form action="edit_ukr.php?id=<?php print $_GET['id']?>" method="post">
<p>
<label>Роль користувача:<br /></label>
